   ...
   {  
      ...
      public void ChangeColor ()
      {
         ...
         switch (choice)
         {
            case "1":
               color = "red";
               Console.WriteLine("Your car is now red!");
               break;
            case "2":
               color = "blue";
               Console.WriteLine("Your car is now blue!");
               break;
            case "3":
               color = "white";
               Console.WriteLine("Your car is now white!");
               break;
            case "4":
               color = "silver";
               Console.WriteLine("Your car is now silver!");
               break;
            case "5":
               color = "black";
               Console.WriteLine("Your car is now black!");
               break;
      ...
      public double Drive (int miles)
      {
         ...
         if (fuelEfficiency < 1)
         {
            ...
            gasUsed = gasUsed + wastedGas; //Accounts for additional gas used due to inefficiency. Will cause math to not add up manually.
         }
